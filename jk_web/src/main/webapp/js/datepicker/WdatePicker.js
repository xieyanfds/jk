...
disabledDates:null,disabledDays:null,opposite:false,onpicking:null,onpicked:null,onclearing:null,oncleared:null,
    eCont:null,vel:null,errMsg:"",quickSel:[],has:{}};WdatePicker=S;
    var V=window,N="document",H="documentElement",A="getElementsByTagName",T,_,R,G,a;switch(navigator.appName){
        case"Microsoft Internet Explorer":R=true;break;
        case"Opera":a=true;break;
        default:G=true;break
    }T=V;if($.$crossFrame){try{while(T.parent[N]!=T[N]&&T.parent[N][A]("frameset").length==0)T=T.parent}catch(P){}}_=J();if($.$wdate)K(_+"skin/WdatePicker.css");var L;if(T.$dp){try{T.$dp.$("my97")}catch(P){L=P.number==-2146823277?true:false}}if(!T.$dp||L){$dp=Q({ff:G,ie:R,opera:a,el:null,win:V,status:L?2:0,defMinDate:$.minDate,defMaxDate:$.maxDate,$:function($){return(typeof $=="string")?this.win[N].getElementById($):$},
        $D:function($,_){
