...
<div class="textbox"></div>
	...
	<div class="modelDiv">
        ...
        <table class="modelTable" cellspacing="1">
			...
			<tr>
				<td class="subModelTitle">部门管理：</td>
				<td class="model_intro_right">对企业部门进行维护和管理。</td>
			</tr>
			<tr>
				<td class="subModelTitle" >用户管理：</td>
				<td class="model_intro_right">可对系统操作用户进行维护管理, 维护信息包括用户账号、所属部门、功能权限等, 并支持对特殊用户账号锁定禁用操作。
			...
			<tr>
				<td class="subModelTitle">多维权限控制模型：</td>
