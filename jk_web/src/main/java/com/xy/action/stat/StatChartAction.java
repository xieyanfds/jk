...
public class StatChartAction extends BaseAction{
	...
	private Logger logger = LoggerFactory.getLogger(StatChartAction.class);
	...
	public String factorysale() throws Exception {
		try {
			...
			logger.error("factorysale exception:{}",e);
		}
		return "factorysale";
	}
	/*public String factorysale() throws Exception {
	...
	public String productsale() throws Exception {
		try {
			...
			logger.error("productsale exception:{}",e);
		}
...
//				+" from login_log_p group by  date_format(login_time,'%H') order by a1) b on (a.a1=b.a1) order by a.a1";
		try {
			...
			logger.error("onlineinfo exception:{}",e);
		}
		return "onlineinfo";
	}
	...
	public String loginList() throws Exception {
		try {
			...
			logger.error("loginList exception:{}",e);
		}
	...
	private String getPieData(List<String> list) {
		...
		try {
			...
			logger.error("getPieData exception:{}",e);
		}
		return sb.toString();
	}
	/**
	...
	private String genBarData(String name,List<String> list) {
		...
		try {
			...
			logger.error("genBarData exception:{}",e);
		}
		return sb.toString();
	}
}
